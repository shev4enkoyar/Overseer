...
{
    private static readonly Func<ApplicationDbContext, Guid, CancellationToken, Task<Project?>> FirstProjectWithoutTracking =
    ...
    {
        return await FirstProjectWithoutTracking.Invoke(dbContext, id, cancellationToken);
    }
